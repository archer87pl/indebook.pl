...
Panel administratora: `http://localhost:8080/` — mapa, wybór rynku, cena bazowa i daty → wycena z backendu (`POST /v1/quote`). System pokrywa 16 polskich rynków (góry/morze/miasta) w 10 województwach.
