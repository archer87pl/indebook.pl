  ...
  return (
    <html lang="pl" className={`${inter.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col">
        <header className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b border-slate-200/80 print:hidden">
        ...
        <footer className="bg-brand-950 text-brand-100/70 mt-12 print:hidden">
            ...
            <div className="space-y-2">
              <p className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold text-white">
                  rez<span className="text-brand-400">io</span>
                </span>
              </p>
